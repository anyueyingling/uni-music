		...
		<view class="contaniner">
			<scroll-view scroll-y="true" >
				<view class="search-search">
					...
					<text class="iconfont icon-guanbi" @tap="handleToDelete" v-show="searchWord.length"></text>
				</view>
...
<style scoped>
	...
	.search-result{ border-top:2px #e4e4e4 solid; padding:30rpx;}
	...
	.search-result-word view:nth-child(2) image{
		width:32rpx;
		height:20rpx;
		margin-right: 10rpx;
	}
